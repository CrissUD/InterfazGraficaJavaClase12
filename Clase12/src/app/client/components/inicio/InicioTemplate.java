...
public class InicioTemplate extends JPanel{
    ...
    public void crearObjetosDecoradores(){
        this.iTarjeta1 = new ImageIcon("Clase12/resources/img/tarjeta1.jpg");
        this.iTarjeta2 = new ImageIcon("Clase12/resources/img/tarjeta2.jpg");
        this.iTarjeta3 = new ImageIcon("Clase12/resources/img/tarjeta3.jpg");
